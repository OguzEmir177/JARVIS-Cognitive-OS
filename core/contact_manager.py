"""
[V9.0] J.A.R.V.I.S. Contact Manager
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
contacts.json'ı ChromaDB tabanlı ilişki grafiğine dönüştürür.
"""
import json
import logging
import os
...
class ContactManager:
    """[V9.0] ChromaDB tabanlı kişi profil yöneticisi."""
    ...
    def initialize(self) -> None:
        ...
        try:
            ...
            if migrated_count > 0:
                logger.info(f"[CONTACT] {migrated_count} yeni kişi migrate edildi.")
            else:
                logger.info(f"[CONTACT] Tüm kişiler ({len(existing)} kayıt) zaten ChromaDB'de.")
        except Exception as e:
            logger.error(f"[CONTACT] Migration hatası: {e}")

    def get_profile(self, name: str) -> dict:
        """Profili cache veya ChromaDB'den çeker."""
    ...
    def update_after_message(self, name: str, message_content: str, success: bool) -> None:
        """Başarılı gönderim sonrası profili günceller."""
        ...
        self._upsert_profile(name, profile)
        self._cache[name] = profile
        logger.info(f"[CONTACT] '{name}' profili güncellendi.")
